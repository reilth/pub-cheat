...
local MainUIColor = COL3RGB(230, 230, 230)    
...
function library:New(name)      
	...
	Menu.Image = "http://www.roblox.com/asset/?id=8172792567"      
...
do 
    ...
    UIGradient_5.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(230, 230, 230)), ColorSequenceKeypoint.new(1, Color3.fromRGB(230, 230, 230))}
			...
			function MSector:Tab(text)      
				...
				function tab:Element(type, text, data, callback)      
					...
					if type == "Jumbobox" then      
						...
						Drop.BorderColor3 = COL3RGB(27, 27, 27)      
							...
							for _,button in pairs(Frame:GetChildren()) do      
								if button:IsA("TextButton") then      
									button.MouseButton1Down:Connect(function()      
										...
										button.TextColor3 = COL3RGB(100, 100, 100)      
										values[tabname][sectorname][tabtext][text] = Element.value      
										callback(Element.value)      
									end)      
									button.MouseEnter:Connect(function()      
...
antiaim:Element("Dropdown", "pitch", {options = {"none", "up", "down","huge", "custom", "super down", "zero", "180", "random"}})   
...
fakelag:Element("Slider", "limit", {min = 0.25, max = 16, default = 0.25})      
...
client:Element("Toggle", "specators list", {}, function(tbl)
			...
			UIGradient_2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(230, 230, 230)), ColorSequenceKeypoint.new(1, Color3.fromRGB(230, 230, 230))}
...
chat:Element("Toggle", "chat spam", nil, function(tbl)      
	if tbl.Toggle then      
		while values.misc.chat["chat spam"].Toggle do      
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "hi" or "eclipseontop!", false, "Innocent", false, true)      
...
local Vxulo = Instance.new("ScreenGui")
local Main = Instance.new("TextButton")
local Frame = Instance.new("Frame")
    

Vxulo.Name = "Vxulo_is_hot"
Vxulo.Parent = game.CoreGui
Vxulo.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
